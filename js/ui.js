...
(function () {
  ...
  function refreshHarvestLite() {
    ...
    if (el.ar) el.ar.textContent = "+" + fmt(Game.perSecond(state)) + "g";
    if (el.hl) el.hl.textContent = fmt(Game.perClick(state)) + "g";
  ...
  function refreshStats() {
    ...
    if (el.m) el.m.textContent = fmt(state.money) + ' €';
    if (el.ar) el.ar.textContent = '+' + fmt(ar) + 'g';
    if (el.hl) el.hl.textContent = fmt(pc) + 'g';
